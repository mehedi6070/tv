...
import { Tv, CircleDot, Sliders, Search, Newspaper, Trophy, Film, Music, Star, Phone, Baby, Radio } from 'lucide-react';
...
const CHANNELS_DATA: Channel[] = [
  ...
  { id: '12', name: 'Peace tv Bangla', url: 'https://dzkyvlfyge.erbvr.com/PeaceTvBangla/tracks-v3a1/mono.m3u8', icon: <Radio className="w-5 h-5" /> },
  { id: '13', name: 'Islamic tv', url: 'https://app24.jagobd.com.bd/c3VydmVyX8RpbEU9Mi8xNy8yMFDEEHGcfRgzQ6NTAgdEoaeFzbF92YWxIZTO0U0ezN1IzMyfvcEdsEfeDeKiNkVN3PTOmdFseWRtaW51aiPhnPTI2/islamictvbd.stream/index.m3u8', icon: <Radio className="w-5 h-5" /> },
  ...
  { id: '31', name: 'ZB Cartun TV', url: 'https://server.zillarbarta.com/zbcatun/video.m3u8', icon: <Baby className="w-5 h-5" /> },
  ...
  { id: '49', name: '24/7 Gopal Bhar', url: 'https://live20.bozztv.com/giatvplayout7/giatv-209611/index.m3u8', icon: <Baby className="w-5 h-5" /> },
];
